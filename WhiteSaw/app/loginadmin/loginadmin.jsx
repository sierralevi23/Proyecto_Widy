  ...
  return (
    <View style={LoginAdminStyles.registroContainer}>
      <View style={LoginAdminStyles.formContainer}>
        ...
        <View style={LoginAdminStyles.googleBtn}>
          <TouchableOpacity style={LoginAdminStyles.googleLoginBtn}>
            <svg style={LoginAdminStyles.googleIcon} width="20" height="20" viewBox="0 0 24 24">
